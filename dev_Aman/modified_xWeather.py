...
nodeTemplate = pd.read_csv("C:/Users/mehmo/Documents/MSDAEN_DAEN690/gaia_2025-02-02_app/User/xWeather/DTN/xWeather-Gz/py+data/xWeather_template/csv/xWeather_template_np_node.csv")    # glyph default tree
...
# Load the JSON data
with open('C:/Users/mehmo/Documents/MSDAEN_DAEN690/gaia_2025-02-02_app/User/xWeather/DTN/xWeather-Gz/py+data/xWeather_Erasmus_US_250.json', "r") as file:
    data = json.load(file)
...
nodeFilePath = "C:/Users/mehmo/Documents/MSDAEN_DAEN690/gaia_2025-02-02_app/dev_Aman/wildfire_np_node.csv"
print("Save: " + nodeFilePath)
nodes = pd.DataFrame.from_records(nodeList)
nodes.to_csv(nodeFilePath, index=False)

tagFilePath = "C:/Users/mehmo/Documents/MSDAEN_DAEN690/gaia_2025-02-02_app/dev_Aman/wildfire_np_tag.csv"
